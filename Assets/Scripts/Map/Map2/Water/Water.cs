...
namespace Bundos.WaterSystem
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        private List<GameObject> splashParticles = new List<GameObject>();
        ...
        {
            CleanupSplashParticles();
        }
        void OnDestroy()
        {
            CleanupSplashParticles();
        }
        private void CleanupSplashParticles()
        {
            foreach (var splash in splashParticles)
            {
                if (splash != null && PrefabUtility.GetPrefabAssetType(splash) == PrefabAssetType.NotAPrefab)
                {
                    DestroyImmediate(splash, true); 
                }
            }
